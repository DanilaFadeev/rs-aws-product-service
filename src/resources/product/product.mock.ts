...
export const products: Product[] = [
  ...
  {
      "id": "14",
      "title": "Cheers to the Best Memories",
      "type": ProductType.Album,
      "artists": [
          "Ty Dolla $ign",
          "dvsn"
  ...
  {
      "id": "15",
      "title": "Madden NFL 22 Soundtrack",
      "type": ProductType.Album,
      "artists": [
  ...
  },
  {
      ...
      "type": ProductType.Single,
      "artists": [
          "Bizzarachi Big Mo Biz J.A.P.A.N The indu$try Boss",
          "Lil Wayne",
          "Mannie Fresh",
          "Uncle Murda",
          "2.17 Manami Kanzaki"
